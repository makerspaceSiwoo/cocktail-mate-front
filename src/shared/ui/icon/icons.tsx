...
export function SettingsIcon(props: IconComponentProps) {
  return (
    <StrokeSvg defaultSize={24} {...props}>
      ...
      <path d="M17.909 10.958 L20.371 10.524 A8.5 8.5 0 0 1 20.371 13.476 L17.909 13.042 A6 6 0 0 1 15.857 16.596 L17.464 18.511 A8.5 8.5 0 0 1 14.907 19.987 L14.052 17.638 A6 6 0 0 1 9.948 17.638 L9.093 19.987 A8.5 8.5 0 0 1 6.536 18.511 L8.143 16.596 A6 6 0 0 1 6.091 13.042 L3.629 13.476 A8.5 8.5 0 0 1 3.629 10.524 L6.091 10.958 A6 6 0 0 1 8.143 7.404 L6.536 5.489 A8.5 8.5 0 0 1 9.093 4.013 L9.948 6.362 A6 6 0 0 1 14.052 6.362 L14.907 4.013 A8.5 8.5 0 0 1 17.464 5.489 L15.857 7.404 A6 6 0 0 1 17.909 10.958 Z" />
    </StrokeSvg>
  );
}
